...
function Editor({
  ...
  }, "1"), "\u30D5\u30EC\u30FC\u30E0\u753B\u50CF"), frameLib.frames.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 8
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, frameLib.frames.map(f => /*#__PURE__*/React.createElement("div", {
    key: f.id,
    style: {
      position: "relative",
      cursor: "pointer"
...
function App() {
  ...
  const applyTemplate = useCallback(function (tpl) {
    ...
    if (tpl === "stack3") {
      ...
      newItems = [mk("builtin-imac", "iMac", 350, 100, 1.1, 0), mk("builtin-ipad", "iPad", 750, 320, 0.6, 10)];
    } else if (tpl === "stack5") {
      newItems = [mk("builtin-imac", "iMac", 320, 40, 1.0, 0), mk("builtin-macbook", "MacBook", 100, 380, 0.55, 10), mk("builtin-ebook", "E-Book", 620, 300, 0.5, -5), mk("builtin-dvd", "DVD", 800, 320, 0.45, 8), mk("builtin-iphone", "iPhone", 500, 400, 0.42, -3)];
    } else if (tpl === "single") {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    src: "data:image/png;base64,",
    style: {
      height: 40
    },
    alt: "Mockup Composer"
  ...
  }, "\uD83D\uDCBB \u5358\u54C1\uFF08MacBook\uFF09"), /*#__PURE__*/React.createElement("button", {
    onClick: function () {
      applyTemplate("pair");
      setShowTpl(false);
    },
    ...
    style: {
      ...
      color: "#fff",
      marginBottom: 16,
      boxShadow: "0 12px 32px rgba(249,115,22,.3)"
    }
  }, "MC"), /*#__PURE__*/React.createElement("h1", {
    style: {
      fontSize: 28,
      fontWeight: 900,
      lineHeight: 1.3,
  ...
  }, "\u7121\u6599\u30FB\u767B\u9332\u4E0D\u8981\u30FB12\u7A2E\u30D5\u30EC\u30FC\u30E0\u5185\u8535"), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 32,
      fontSize: 10,
      color: "#333",
