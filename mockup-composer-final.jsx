      ...
      {showShareModal && (
        ...
        <div style={{ maxWidth: 520, margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ textAlign: "center", padding: "60px 0 32px" }}>
            <div style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", width: 72, height: 72, borderRadius: 18, background: "linear-gradient(135deg,#f97316,#ea580c)", fontSize: 32, fontWeight: 900, color: "#fff", marginBottom: 16, boxShadow: "0 12px 32px rgba(249,115,22,.3)" }}>MC</div>
          ...
          <div style={{ textAlign: "center", paddingBottom: 60 }}>
            ...
            <div style={{ fontSize: 11, color: "#555", marginTop: 10 }}>無料・登録不要・12種フレーム内蔵</div>
